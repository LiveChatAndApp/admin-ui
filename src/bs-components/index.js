...
import * as bsStatusText from './bsStatusText'
...
import * as bsTag from './tag'

Vue.component('bs-tag', bsTag.default)
Vue.component('bs-status', status.components.bsStatus)
Vue.component('bs-status-text', bsStatusText.default)
...
Vue.component('bs-delete-button', button.components.deleteButton)
...
Vue.component('bs-bank-select', bankSelect)
Vue.component('bs-account-select', accountSelect)
Vue.component('bs-channel-select', channelSelect)

Vue.component('bs-catalog-select', catalogSelect)
